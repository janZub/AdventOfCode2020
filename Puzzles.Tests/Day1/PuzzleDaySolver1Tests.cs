...
namespace Puzzles.Tests.Day1
{
    public class PuzzleDaySolver1Tests
    {
        ...
        {
            yield return new object[] { new List<ulong>() { 1, 2, 3, 4, 2017 }, 2020 };
            yield return new object[] { new List<ulong>() { 2011, 300, 3, 4, 200, 1720 }, 2020 };
            yield return new object[] { new List<ulong>() { 2011, 300, 3, 4, 200, 1720 }, 2311 };
        }
        public static IEnumerable<object[]> NumbersThatNotSumToN()
        {
            yield return new object[] { new List<ulong>() { 3000 }, 2020 };
            yield return new object[] { new List<ulong>() { 10, 31, 50, 11, 231, 2308, 32123 }, 2020 };
        }

        public static IEnumerable<object[]> KNumbersThatSumToN()
        {
            yield return new object[] {
                new List<ulong>() { 1, 2, 3, 5, 6, 2017 },
                2, 2020,
                new List<ulong>() {3,2017 }
            };

            yield return new object[] {
                new List<ulong>() { 20, 33, 44, 57, 199, 200 ,1800},
                3, 2020,
                new List<ulong>() { 200, 1800, 20 } };

            yield return new object[] {
                new List<ulong>() { 20, 33, 44, 57, 199, 200 ,1800},
                3 ,97,
                new List<ulong>(){ 33, 44, 20 } };
        }
